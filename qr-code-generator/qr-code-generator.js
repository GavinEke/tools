(() => {
  ...
  function getOptions() {
    ...
    const errorLevel = document.querySelector('input[name="error-level"]:checked').value;
  ...
  function init() {
    document.getElementById('generate-btn').addEventListener('click', () => generateQRCode(true));
    document.getElementById('regenerate-btn').addEventListener('click', () => generateQRCode(true));
