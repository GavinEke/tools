(() => {
  ...
  function renderResults(results) {
    ...
    if (results.ips.length > 0) {
      ...
      ipList.innerHTML =
        '<div class="list-group-item text-muted">No IPs found</div>';
    }
    ...
    if (results.domains.length > 0) {
      ...
      domainList.innerHTML =
        '<div class="list-group-item text-muted">No domains found</div>';
    }
    ...
    if (results.urls.length > 0) {
      ...
      urlList.innerHTML =
        '<div class="list-group-item text-muted">No URLs found</div>';
    }
