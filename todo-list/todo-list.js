(() => {
  ...
  function init() {
    ...
    document.getElementById('filter-all').addEventListener('change', () => setFilter('all'));
    document.getElementById('filter-active').addEventListener('change', () => setFilter('active'));
    document.getElementById('filter-completed').addEventListener('change', () => setFilter('completed'));
