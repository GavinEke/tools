(() => {
  ...
  function displayParsedInfo(ua) {
    ...
    document.getElementById("parsed-mobile").textContent = parsed.mobile
      ? "Yes"
      : "No";
  }
  ...
  function init() {
    ...
    document
      .getElementById("copy-current-btn")
      .addEventListener("click", copyCurrentUA);
    document
      .getElementById("analyze-btn")
      .addEventListener("click", analyzeCustomUA);
    document
      .getElementById("clear-btn")
      .addEventListener("click", clearCustomUA);
