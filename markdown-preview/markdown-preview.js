(() => {
  ...
  function setViewMode(mode) {
    ...
    textareaWrapper.innerHTML =
      '<label for="markdown-input" class="form-label fw-medium">Markdown</label><textarea class="form-control font-monospace h-100" id="markdown-input" rows="20" placeholder="Enter Markdown here...">' +
      savedMarkdown.replace(/</g, "&lt;").replace(/>/g, "&gt;") +
      "</textarea>";

    const previewWrapper = document.createElement("div");
    previewWrapper.className = "h-100";
    previewWrapper.innerHTML =
      '<label class="form-label fw-medium">Preview</label><div class="card h-100"><div class="card-body" id="preview-output" style="overflow-y: auto;"></div></div>';
  ...
  function init() {
    ...
    document
      .getElementById("view-split")
      .addEventListener("change", () => setViewMode("split"));
    document
      .getElementById("view-edit")
      .addEventListener("change", () => setViewMode("edit"));
    document
      .getElementById("view-preview")
      .addEventListener("change", () => setViewMode("preview"));
